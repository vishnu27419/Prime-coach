...
import ViewAthleteEventModal from "./modal/ViewAthleteEventModal";
// import ViewTeamPlayerEventModal from "./modal/ViewTeamPlayerEventModal";
// import ViewEventModal from "./ViewEventModal";

export class viewAthleteEvent extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  toggleModal = (item) => {
    ...
    this.setState({
      ...
      userAttandance: item?.is_available,
    });
  ...
  render() {
    ...
    console.log("selectedEvent02230.0.", selectedEvent);
    return (
      <div
        className="add-event "
        style={
...
export default viewAthleteEvent;
