...
class DeleteWorkoutExerciseModalForExercise extends React.Component {
  render() {
    return (
      <div>
        <Modal
        ...
        >
          ...
          <Modal.Footer>
            <button
              ...
              data-dismiss="modal"
              onClick={this.props.deleteWorkoutExercise}
            >
              OK
            </button>
            <button
...
export default DeleteWorkoutExerciseModalForExercise;
